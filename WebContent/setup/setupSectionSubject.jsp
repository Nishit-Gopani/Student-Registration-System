...
function showSectionDetails(pageNo){
	...
	xmlhttp.open("get","base?module=section&action=pageData&pageNo="+ pageNo +"&pageSize=15",true);
	xmlhttp.send(null);
}
...
function showSectionSubjectMappingDetails(pageNo){
	...
	xmlhttp.open("get","base?module=sectionsubjectmapping&action=pageData&pageNo="+ pageNo +"&pageSize=15",true);
	xmlhttp.send(null);
} 
...
function loadSectionSubject(){
 ...
 function showSectionSeatDetails(pageNo){
		...
		xmlhttp.open("get","base?module=campussectionseatevaluation&action=pageData&pageNo="+ pageNo +"&pageSize=15",true);
		xmlhttp.send(null);
	} 
	// Display Page Footer Details 
